...
class Archer(BaseEnemy):
    def __init__(
            self,
            max_health: float = ARCHER_MAX_HEALTH,
            melee_damage: float = ARCHER_MELEE_DAMAGE,
            range_damage: float = ARCHER_RANGE_DAMAGE,
            speed: float = ARCHER_SPEED,
            invincibility_time: float = 0,
            attack_cooldown: float = ARCHER_ATTACK_COOLDOWN,
        ...
        additional_sprite = arcade.Sprite(TexturePaths.bow, scale=1.2)
        additional_sprites = ((additional_sprite, 15, -5),)
        walk_textures = (TexturePaths.archer_walk_1, TexturePaths.archer_walk_2, TexturePaths.archer_walk_3,
                         TexturePaths.archer_walk_4)
